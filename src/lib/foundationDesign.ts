...
export function designFooting(
  ...
  let B = reaction.manualB ?? 1500;
  let L = reaction.manualL ?? 1500;

  if (reaction.manualB === undefined || reaction.manualL === undefined || reaction.manualH === undefined) {
  ...
  if (reaction.manualB === undefined || reaction.manualL === undefined) {
